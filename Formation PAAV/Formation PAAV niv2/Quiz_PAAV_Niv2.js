...
const questions = [
    ...
    },
    {
        ...
        answers: ["Ils déterminent les modalités de calcul des primes", "Ils déterminent les caractéristiques de base des primes (soumis à cotisation, imposable, inclus dans les CP, etc..)", "Ils déterminent les modalités de calcul de la prime d’ancienneté"],
...
function showResults() {
    ...
    if (score >= 12) {
        ...
        homeBtn.textContent = "Page d'accueil";
